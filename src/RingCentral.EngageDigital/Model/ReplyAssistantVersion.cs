...
namespace RingCentral.EngageDigital.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReplyAssistantVersion :  IEquatable<ReplyAssistantVersion>, IValidatableObject
    {
        /// <summary>
        /// Defines Format
        /// </summary>
        ...
        protected ReplyAssistantVersion() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReplyAssistantVersion" /> class.
        /// </summary>
        ...
        public ReplyAssistantVersion(int attachmentsCount = default(int), string body = default(string), DateTime createdAt = default(DateTime), string entryId = default(string), FormatEnum? format = default(FormatEnum?), string id = default(string), string language = default(string), Collection<string> sourceIds = default(Collection<string>), DateTime updatedAt = default(DateTime))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ReplyAssistantVersion and cannot be null");;
