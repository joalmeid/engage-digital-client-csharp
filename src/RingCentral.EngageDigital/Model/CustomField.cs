...
namespace RingCentral.EngageDigital.Model
{
        ...
        internal partial class CustomField :  IEquatable<CustomField>
    {
        ...
        public CustomField(string associatedTypeName = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), string id = default(string), string key = default(string), string label = default(string), bool? multiple = default(bool?), int? position = default(int?), string type = default(string), DateTimeOffset? updatedAt = default(DateTimeOffset?))
        {
