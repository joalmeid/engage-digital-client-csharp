...
namespace RingCentral.EngageDigital.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetAllCustomFieldsResponse :  IEquatable<GetAllCustomFieldsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetAllCustomFieldsResponse(int count = default(int), int limit = default(int), int offset = default(int), Collection<CustomField> records = default(Collection<CustomField>))
        {
            this.Count = count;
            this.Limit = limit;
            this.Offset = offset;
        ...
        public Collection<CustomField> Records { get; set; }
