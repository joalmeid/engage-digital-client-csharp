...
namespace RingCentral.EngageDigital.Model
{
    ...
    /// </summary>
    [DataContract]
        internal partial class Intervention :  IEquatable<Intervention>
    {
        /// <summary>
        ...
        public Intervention(List<string> categoryIds = default(List<string>), bool? closed = default(bool?), DateTimeOffset? closedAt = default(DateTimeOffset?), int? commentsCount = default(int?), string contentId = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), Object customFields = default(Object), DateTimeOffset? deferredAt = default(DateTimeOffset?), string firstUserReplyId = default(string), int? firstUserReplyIn = default(int?), int? firstUserReplyInBh = default(int?), string id = default(string), string identityId = default(string), int? lastUserReplyIn = default(int?), int? lastUserReplyInBh = default(int?), string sourceId = default(string), string status = default(string), string threadId = default(string), DateTimeOffset? updatedAt = default(DateTimeOffset?), string userId = default(string), int? userRepliesCount = default(int?), int? userReplyInAverage = default(int?), int? userReplyInAverageBh = default(int?), int? userReplyInAverageCount = default(int?))
        {
