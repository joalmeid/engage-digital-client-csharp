...
namespace RingCentral.EngageDigital.Model
{
    ...
    public partial class Content :  IEquatable<Content>, IValidatableObject
    {
        ...
        public Content(bool approvalRequired = default(bool), Collection<ContentAttachment> attachments = default(Collection<ContentAttachment>), int attachmentsCount = default(int), string authorId = default(string), string body = default(string), ContentBodyFormatted bodyFormatted = default(ContentBodyFormatted), BodyInputFormatEnum? bodyInputFormat = default(BodyInputFormatEnum?), Collection<string> categoryIds = default(Collection<string>), Object contextData = default(Object), DateTime createdAt = default(DateTime), string createdFrom = default(string), string creatorId = default(string), string foreignId = default(string), string id = default(string), string inReplyToAuthorId = default(string), string inReplyToId = default(string), string interventionId = default(string), string language = default(string), bool privateMessage = default(bool), bool published = default(bool), bool remotelyDeleted = default(bool), string sourceId = default(string), string sourceType = default(string), string sourceUrl = default(string), string status = default(string), string synchronizationStatus = default(string), string threadId = default(string), string title = default(string), string type = default(string), DateTime updatedAt = default(DateTime))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for Content and cannot be null");;
        ...
        public Collection<ContentAttachment> Attachments { get; set; }
