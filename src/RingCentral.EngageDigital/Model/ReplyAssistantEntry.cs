...
namespace RingCentral.EngageDigital.Model
{
    ...
    /// </summary>
    [DataContract]
        internal partial class ReplyAssistantEntry :  IEquatable<ReplyAssistantEntry>
    {
        /// <summary>
        ...
        public ReplyAssistantEntry(List<string> categoryIds = default(List<string>), DateTimeOffset? createdAt = default(DateTimeOffset?), string entryGroupId = default(string), string foreignId = default(string), string id = default(string), string label = default(string), string shortcuts = default(string), List<string> sourceIds = default(List<string>), DateTimeOffset? updatedAt = default(DateTimeOffset?), List<string> versionIds = default(List<string>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ReplyAssistantEntry and cannot be null");
            }
            else
            {
                this.Id = id;
