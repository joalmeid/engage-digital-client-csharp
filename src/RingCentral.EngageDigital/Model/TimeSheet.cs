...
namespace RingCentral.EngageDigital.Model
{
    ...
    public partial class TimeSheet :  IEquatable<TimeSheet>, IValidatableObject
    {
        ...
        public TimeSheet(bool active = default(bool), DateTime createdAt = default(DateTime), string fridayHours = default(string), Collection<TimeSheetHoliday> holidays = default(Collection<TimeSheetHoliday>), string id = default(string), string label = default(string), string mondayHours = default(string), string saturdayHours = default(string), Collection<string> sourceIds = default(Collection<string>), string sundayHours = default(string), string thursdayHours = default(string), string timezone = default(string), string tuesdayHours = default(string), DateTime updatedAt = default(DateTime), string wednesdayHours = default(string))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for TimeSheet and cannot be null");;
            this.Active = active;
        ...
        public Collection<TimeSheetHoliday> Holidays { get; set; }
