...
namespace RingCentral.EngageDigital.Model
{
        ...
        internal partial class TimeSheet :  IEquatable<TimeSheet>
    {
        ...
        public TimeSheet(bool? active = default(bool?), DateTimeOffset? createdAt = default(DateTimeOffset?), string fridayHours = default(string), List<TimeSheetHoliday> holidays = default(List<TimeSheetHoliday>), string id = default(string), string label = default(string), string mondayHours = default(string), string saturdayHours = default(string), List<string> sourceIds = default(List<string>), string sundayHours = default(string), string thursdayHours = default(string), string timezone = default(string), string tuesdayHours = default(string), DateTimeOffset? updatedAt = default(DateTimeOffset?), string wednesdayHours = default(string))
        {
