...
namespace RingCentral.EngageDigital.Model
{
    ...
    public partial class Thread :  IEquatable<Thread>, IValidatableObject
    {
        ...
        public Thread(Collection<string> categoryIds = default(Collection<string>), bool closed = default(bool), int contentsCount = default(int), DateTime createdAt = default(DateTime), Object extraData = default(Object), string foreignId = default(string), string id = default(string), int interventionsCount = default(int), string sourceId = default(string), Collection<string> threadCategoryIds = default(Collection<string>), string title = default(string), DateTime updatedAt = default(DateTime))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for Thread and cannot be null");;
        ...
        public Collection<string> ThreadCategoryIds { get; set; }
