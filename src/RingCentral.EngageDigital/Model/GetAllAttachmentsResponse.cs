...
namespace RingCentral.EngageDigital.Model
{
    ...
    /// </summary>
    [DataContract]
        internal partial class GetAllAttachmentsResponse :  IEquatable<GetAllAttachmentsResponse>
    {
        /// <summary>
        ...
        public GetAllAttachmentsResponse(int? count = default(int?), int? limit = default(int?), int? offset = default(int?), List<Attachment> records = default(List<Attachment>))
        {
            this.Count = count;
            this.Limit = limit;
            this.Offset = offset;
