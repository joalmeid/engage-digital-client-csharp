...
namespace RingCentral.EngageDigital.Model
{
        ...
        public partial class User :  IEquatable<User>
    {
        ...
        public User(List<string> categoryIds = default(List<string>), DateTimeOffset? createdAt = default(DateTimeOffset?), string email = default(string), bool? enabled = default(bool?), string externalId = default(string), string firstname = default(string), string gender = default(string), string id = default(string), List<string> identityIds = default(List<string>), bool? invitationPending = default(bool?), string lastname = default(string), string locale = default(string), string nickname = default(string), string rcUserId = default(string), string roleId = default(string), List<string> spokenLanguages = default(List<string>), List<string> teamIds = default(List<string>), string timezone = default(string), DateTimeOffset? updatedAt = default(DateTimeOffset?))
        {
