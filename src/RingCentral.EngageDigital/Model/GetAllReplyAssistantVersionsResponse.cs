...
namespace RingCentral.EngageDigital.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetAllReplyAssistantVersionsResponse :  IEquatable<GetAllReplyAssistantVersionsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetAllReplyAssistantVersionsResponse(int count = default(int), int limit = default(int), int offset = default(int), Collection<ReplyAssistantVersion> records = default(Collection<ReplyAssistantVersion>))
        {
            this.Count = count;
            this.Limit = limit;
            this.Offset = offset;
        ...
        public Collection<ReplyAssistantVersion> Records { get; set; }
