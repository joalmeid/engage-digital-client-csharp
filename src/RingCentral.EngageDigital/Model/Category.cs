...
namespace RingCentral.EngageDigital.Model
{
    ...
    public partial class Category :  IEquatable<Category>, IValidatableObject
    {
        ...
        public Category(int color = default(int), DateTime createdAt = default(DateTime), string id = default(string), bool mandatory = default(bool), bool multiple = default(bool), string name = default(string), string parentId = default(string), bool postQualification = default(bool), Collection<string> sourceIds = default(Collection<string>), bool unselectable = default(bool), DateTime updatedAt = default(DateTime))
        {
