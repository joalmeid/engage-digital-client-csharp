...
namespace RingCentral.EngageDigital.Model
{
    ...
    public partial class Folder :  IEquatable<Folder>, IValidatableObject
    {
        ...
        public Folder(DateTime createdAt = default(DateTime), string id = default(string), string label = default(string), string parentId = default(string), int position = default(int), string query = default(string), bool renderThreadsCount = default(bool), Restriction roleRestriction = default(Restriction), DateTime updatedAt = default(DateTime))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for Folder and cannot be null");;
