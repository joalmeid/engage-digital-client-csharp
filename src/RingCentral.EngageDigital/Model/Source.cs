...
namespace RingCentral.EngageDigital.Model
{
    ...
    public partial class Source :  IEquatable<Source>, IValidatableObject
    {
        ...
        public Source(bool active = default(bool), bool autoDetectContentLanguage = default(bool), string channelId = default(string), int color = default(int), string communityId = default(string), bool contentArchiving = default(bool), long contentArchivingPeriod = default(long), Collection<string> contentLanguages = default(Collection<string>), DateTime createdAt = default(DateTime), Collection<string> defaultCategoryIds = default(Collection<string>), string defaultContentLanguage = default(string), string errorMessage = default(string), bool hiddenFromStats = default(bool), string id = default(string), int interventionMessagesBoost = default(int), string name = default(string), SlaExpiredStrategyEnum? slaExpiredStrategy = default(SlaExpiredStrategyEnum?), int slaResponse = default(int), string status = default(string), Collection<string> timeSheetIds = default(Collection<string>), int transferredTasksBoost = default(int), string type = default(string), DateTime updatedAt = default(DateTime), Collection<string> userThreadDefaultCategoryIds = default(Collection<string>))
        {
            this.Active = active;
        ...
        public Collection<string> ContentLanguages { get; set; }
        ...
        public Collection<string> DefaultCategoryIds { get; set; }
        ...
        public Collection<string> TimeSheetIds { get; set; }
        ...
        public Collection<string> UserThreadDefaultCategoryIds { get; set; }
