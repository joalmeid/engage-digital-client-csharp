...
namespace RingCentral.EngageDigital.Model
{
    ...
    /// </summary>
    [DataContract]
        internal partial class GetAllTeamsResponse :  IEquatable<GetAllTeamsResponse>
    {
        /// <summary>
        ...
        public GetAllTeamsResponse(int? count = default(int?), int? limit = default(int?), int? offset = default(int?), List<Team> records = default(List<Team>))
        {
            this.Count = count;
            this.Limit = limit;
            this.Offset = offset;
        ...
        public List<Team> Records { get; set; }
