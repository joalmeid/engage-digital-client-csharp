...
namespace RingCentral.EngageDigital.Model
{
        ...
        internal partial class Channel :  IEquatable<Channel>
    {
        ...
        public Channel(DateTimeOffset? createdAt = default(DateTimeOffset?), int? hardCapability = default(int?), string id = default(string), string label = default(string), string name = default(string), int? softCapability = default(int?), List<string> sourceIds = default(List<string>), int? taskTimeoutSeconds = default(int?), DateTimeOffset? updatedAt = default(DateTimeOffset?))
        {
