...
namespace RingCentral.EngageDigital.Model
{
    ...
    public partial class Task :  IEquatable<Task>, IValidatableObject
    {
        ...
        public Task(DateTime acceptedAt = default(DateTime), Collection<string> agentIds = default(Collection<string>), string channelId = default(string), DateTime completedAt = default(DateTime), string contentId = default(string), DateTime createdAt = default(DateTime), DateTime expireAt = default(DateTime), string id = default(string), string interventionId = default(string), DateTime lockedAt = default(DateTime), int priority = default(int), string step = default(string), string threadId = default(string), DateTime transferedAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for Task and cannot be null");;
        ...
        public Collection<string> AgentIds { get; set; }
