...
namespace RingCentral.EngageDigital.Model
{
        ...
        internal partial class Webhook :  IEquatable<Webhook>
    {
        ...
        public Webhook(bool? active = default(bool?), WebhookAccessToken apiAccessToken = default(WebhookAccessToken), string id = default(string), List<string> registeredEvents = default(List<string>), bool? stagingUse = default(bool?), string url = default(string), string verifyToken = default(string))
        {
