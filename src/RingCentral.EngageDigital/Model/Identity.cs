...
namespace RingCentral.EngageDigital.Model
{
        ...
        public partial class Identity :  IEquatable<Identity>
    {
        ...
        public Identity(string avatarUrl = default(string), string communityId = default(string), string communityUrl = default(string), string company = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), string displayName = default(string), string email = default(string), Object extraValues = default(Object), string firstname = default(string), string foreignId = default(string), string gender = default(string), string homePhone = default(string), string id = default(string), string identityGroupId = default(string), string lastname = default(string), string mobilePhone = default(string), string screenname = default(string), string type = default(string), DateTimeOffset? updatedAt = default(DateTimeOffset?), List<string> userIds = default(List<string>), string uuid = default(string))
        {
