...
namespace RingCentral.EngageDigital.Model
{
    ...
    public partial class IdentityGroup :  IEquatable<IdentityGroup>, IValidatableObject
    {
        ...
        public IdentityGroup(string avatarUrl = default(string), string company = default(string), DateTime createdAt = default(DateTime), Object customFieldValues = default(Object), Collection<string> emails = default(Collection<string>), string firstname = default(string), string gender = default(string), Collection<string> homePhones = default(Collection<string>), string id = default(string), Collection<string> identityIds = default(Collection<string>), string lastname = default(string), Collection<string> mobilePhones = default(Collection<string>), string notes = default(string), Collection<string> tagIds = default(Collection<string>), DateTime updatedAt = default(DateTime))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for IdentityGroup and cannot be null");;
        ...
        public Collection<string> HomePhones { get; set; }
        ...
        public Collection<string> MobilePhones { get; set; }
        ...
        public Collection<string> TagIds { get; set; }
