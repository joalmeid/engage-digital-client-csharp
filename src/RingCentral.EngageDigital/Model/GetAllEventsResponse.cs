...
namespace RingCentral.EngageDigital.Model
{
    ...
    public partial class GetAllEventsResponse :  IEquatable<GetAllEventsResponse>, IValidatableObject
    {
        ...
        public GetAllEventsResponse(int count = default(int), int limit = default(int), int offset = default(int), Collection<Event> records = default(Collection<Event>))
        {
            this.Count = count;
            this.Limit = limit;
            this.Offset = offset;
        ...
        public Collection<Event> Records { get; set; }
