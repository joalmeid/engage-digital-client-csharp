...
namespace RingCentral.EngageDigital.Api
{
    ...
    /// </summary>
        internal interface ITimezonesApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        internal partial class TimezonesApi : ITimezonesApi
    {
        ...
        /// <returns></returns>
        public TimezonesApi(RingCentral.EngageDigital.Client.Configuration configuration = null)
        {
        ...
        {
             ApiResponse<List<Timezone>> localVarResponse = GetAllTimezonesWithHttpInfo();
        ...
        /// <exception cref="RingCentral.EngageDigital.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;Timezone&gt;</returns>
        public ApiResponse< List<Timezone> > GetAllTimezonesWithHttpInfo ()
        {
            ...
            {
                Exception exception = ExceptionFactory("GetAllTimezones", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<List<Timezone>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => string.Join(",", x.Value)),
                (List<Timezone>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<Timezone>)));
        }
        ...
        {
             ApiResponse<List<Timezone>> localVarResponse = await GetAllTimezonesAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="RingCentral.EngageDigital.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (List&lt;Timezone&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<Timezone>>> GetAllTimezonesAsyncWithHttpInfo ()
        {
