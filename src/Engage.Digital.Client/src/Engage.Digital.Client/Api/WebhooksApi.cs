...
namespace Engage.Digital.Client.Api
{
    ...
    public partial class WebhooksApi : IWebhooksApi
    {
        ...
        /// <returns></returns>
        public WebhooksApi(Engage.Digital.Client.Configuration configuration)
        {
        ...
        public WebhooksApi(Engage.Digital.Client.ISynchronousClient client,Engage.Digital.Client.IAsynchronousClient asyncClient, Engage.Digital.Client.IReadableConfiguration configuration)
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<Webhook> localVarResponse = CreateWebhookWithHttpInfo(accessToken, label, url, registeredEvents, active, stagingUse, verifyToken, secret);
        ...
        /// <param name="secret">The secret key that will be served as a ​&#x60;X-Dimelo-Secret​&#x60; header in every request. (optional)</param>
        /// <returns>ApiResponse of Webhook</returns>
        public Engage.Digital.Client.ApiResponse< Webhook > CreateWebhookWithHttpInfo (string accessToken, string label, string url, List<string> registeredEvents, bool? active = null, bool? stagingUse = null, string verifyToken = null, string secret = null)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'accessToken' when calling WebhooksApi->CreateWebhook");

            // verify the required parameter 'label' is set
            if (label == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'label' when calling WebhooksApi->CreateWebhook");

            // verify the required parameter 'url' is set
            if (url == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'url' when calling WebhooksApi->CreateWebhook");

            // verify the required parameter 'registeredEvents' is set
            if (registeredEvents == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'registeredEvents' when calling WebhooksApi->CreateWebhook");
            ...
            if (accessToken != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "access_token", accessToken))
                {
            ...
            if (stagingUse != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "staging_use", stagingUse))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (url != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "url", url))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (verifyToken != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "verify_token", verifyToken))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (secret != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "secret", secret))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (registeredEvents != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("multi", "registered_events[]", registeredEvents))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
        ...
        {
             Engage.Digital.Client.ApiResponse<Webhook> localVarResponse = await CreateWebhookAsyncWithHttpInfo(accessToken, label, url, registeredEvents, active, stagingUse, verifyToken, secret);
             return localVarResponse.Data;
        ...
        /// <param name="secret">The secret key that will be served as a ​&#x60;X-Dimelo-Secret​&#x60; header in every request. (optional)</param>
        /// <returns>Task of ApiResponse (Webhook)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<Webhook>> CreateWebhookAsyncWithHttpInfo (string accessToken, string label, string url, List<string> registeredEvents, bool? active = null, bool? stagingUse = null, string verifyToken = null, string secret = null)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'accessToken' when calling WebhooksApi->CreateWebhook");
        ...
        {
             Engage.Digital.Client.ApiResponse<Webhook> localVarResponse = DeleteWebhookWithHttpInfo(webhookId, accessToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="accessToken">Access token.</param>
        /// <returns>ApiResponse of Webhook</returns>
        public Engage.Digital.Client.ApiResponse< Webhook > DeleteWebhookWithHttpInfo (string webhookId, string accessToken)
        {
            // verify the required parameter 'webhookId' is set
            if (webhookId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'webhookId' when calling WebhooksApi->DeleteWebhook");

            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'accessToken' when calling WebhooksApi->DeleteWebhook");
            ...
            if (webhookId != null)
                requestOptions.PathParameters.Add("webhookId", Engage.Digital.Client.ClientUtils.ParameterToString(webhookId)); // path parameter
            if (accessToken != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "access_token", accessToken))
                {
        ...
        {
             Engage.Digital.Client.ApiResponse<Webhook> localVarResponse = await DeleteWebhookAsyncWithHttpInfo(webhookId, accessToken);
             return localVarResponse.Data;
        ...
        /// <param name="accessToken">Access token.</param>
        /// <returns>Task of ApiResponse (Webhook)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<Webhook>> DeleteWebhookAsyncWithHttpInfo (string webhookId, string accessToken)
        {
            // verify the required parameter 'webhookId' is set
            if (webhookId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'webhookId' when calling WebhooksApi->DeleteWebhook");
        ...
        {
             Engage.Digital.Client.ApiResponse<GetAllWebhooksResponse> localVarResponse = GetAllWebhooksWithHttpInfo(accessToken, offset, limit);
             return localVarResponse.Data;
        }
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>ApiResponse of GetAllWebhooksResponse</returns>
        public Engage.Digital.Client.ApiResponse< GetAllWebhooksResponse > GetAllWebhooksWithHttpInfo (string accessToken, int? offset = null, int? limit = null)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'accessToken' when calling WebhooksApi->GetAllWebhooks");
        ...
        {
             Engage.Digital.Client.ApiResponse<GetAllWebhooksResponse> localVarResponse = await GetAllWebhooksAsyncWithHttpInfo(accessToken, offset, limit);
             return localVarResponse.Data;
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>Task of ApiResponse (GetAllWebhooksResponse)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<GetAllWebhooksResponse>> GetAllWebhooksAsyncWithHttpInfo (string accessToken, int? offset = null, int? limit = null)
        {
            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'accessToken' when calling WebhooksApi->GetAllWebhooks");
        ...
        {
             Engage.Digital.Client.ApiResponse<Webhook> localVarResponse = GetWebhookWithHttpInfo(webhookId, accessToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="accessToken">Access token.</param>
        /// <returns>ApiResponse of Webhook</returns>
        public Engage.Digital.Client.ApiResponse< Webhook > GetWebhookWithHttpInfo (string webhookId, string accessToken)
        {
            // verify the required parameter 'webhookId' is set
            if (webhookId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'webhookId' when calling WebhooksApi->GetWebhook");

            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'accessToken' when calling WebhooksApi->GetWebhook");
        ...
        {
             Engage.Digital.Client.ApiResponse<Webhook> localVarResponse = await GetWebhookAsyncWithHttpInfo(webhookId, accessToken);
             return localVarResponse.Data;
        ...
        /// <param name="accessToken">Access token.</param>
        /// <returns>Task of ApiResponse (Webhook)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<Webhook>> GetWebhookAsyncWithHttpInfo (string webhookId, string accessToken)
        {
            // verify the required parameter 'webhookId' is set
            if (webhookId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'webhookId' when calling WebhooksApi->GetWebhook");
        ...
        {
             Engage.Digital.Client.ApiResponse<Webhook> localVarResponse = UpdateWebhookWithHttpInfo(webhookId, accessToken, active, label, stagingUse, url, verifyToken, secret, registeredEvents);
             return localVarResponse.Data;
        }
        ...
        /// <param name="registeredEvents">An array containing all the events that your webhook wants to subscribe. (optional)</param>
        /// <returns>ApiResponse of Webhook</returns>
        public Engage.Digital.Client.ApiResponse< Webhook > UpdateWebhookWithHttpInfo (string webhookId, string accessToken, bool? active = null, string label = null, bool? stagingUse = null, string url = null, string verifyToken = null, string secret = null, List<string> registeredEvents = null)
        {
            // verify the required parameter 'webhookId' is set
            if (webhookId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'webhookId' when calling WebhooksApi->UpdateWebhook");

            // verify the required parameter 'accessToken' is set
            if (accessToken == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'accessToken' when calling WebhooksApi->UpdateWebhook");
        ...
        {
             Engage.Digital.Client.ApiResponse<Webhook> localVarResponse = await UpdateWebhookAsyncWithHttpInfo(webhookId, accessToken, active, label, stagingUse, url, verifyToken, secret, registeredEvents);
             return localVarResponse.Data;
        ...
        /// <param name="registeredEvents">An array containing all the events that your webhook wants to subscribe. (optional)</param>
        /// <returns>Task of ApiResponse (Webhook)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<Webhook>> UpdateWebhookAsyncWithHttpInfo (string webhookId, string accessToken, bool? active = null, string label = null, bool? stagingUse = null, string url = null, string verifyToken = null, string secret = null, List<string> registeredEvents = null)
        {
            // verify the required parameter 'webhookId' is set
            if (webhookId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'webhookId' when calling WebhooksApi->UpdateWebhook");
