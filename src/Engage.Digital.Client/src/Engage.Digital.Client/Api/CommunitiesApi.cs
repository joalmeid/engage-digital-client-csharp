...
namespace Engage.Digital.Client.Api
{
    ...
    public partial class CommunitiesApi : ICommunitiesApi
    {
        ...
        /// <returns></returns>
        public CommunitiesApi(Engage.Digital.Client.Configuration configuration)
        {
        ...
        public CommunitiesApi(Engage.Digital.Client.ISynchronousClient client,Engage.Digital.Client.IAsynchronousClient asyncClient, Engage.Digital.Client.IReadableConfiguration configuration)
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<GetAllCommunitiesResponse> localVarResponse = GetAllCommunitiesWithHttpInfo(offset, limit);
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>ApiResponse of GetAllCommunitiesResponse</returns>
        public Engage.Digital.Client.ApiResponse< GetAllCommunitiesResponse > GetAllCommunitiesWithHttpInfo (int? offset = null, int? limit = null)
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<GetAllCommunitiesResponse> localVarResponse = await GetAllCommunitiesAsyncWithHttpInfo(offset, limit);
             return localVarResponse.Data;
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>Task of ApiResponse (GetAllCommunitiesResponse)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<GetAllCommunitiesResponse>> GetAllCommunitiesAsyncWithHttpInfo (int? offset = null, int? limit = null)
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<Community> localVarResponse = GetCommunityWithHttpInfo(communityId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="communityId"></param>
        /// <returns>ApiResponse of Community</returns>
        public Engage.Digital.Client.ApiResponse< Community > GetCommunityWithHttpInfo (string communityId)
        {
            // verify the required parameter 'communityId' is set
            if (communityId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'communityId' when calling CommunitiesApi->GetCommunity");
            ...
            if (communityId != null)
                requestOptions.PathParameters.Add("communityId", Engage.Digital.Client.ClientUtils.ParameterToString(communityId)); // path parameter
        ...
        {
             Engage.Digital.Client.ApiResponse<Community> localVarResponse = await GetCommunityAsyncWithHttpInfo(communityId);
             return localVarResponse.Data;
        ...
        /// <param name="communityId"></param>
        /// <returns>Task of ApiResponse (Community)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<Community>> GetCommunityAsyncWithHttpInfo (string communityId)
        {
            // verify the required parameter 'communityId' is set
            if (communityId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'communityId' when calling CommunitiesApi->GetCommunity");
