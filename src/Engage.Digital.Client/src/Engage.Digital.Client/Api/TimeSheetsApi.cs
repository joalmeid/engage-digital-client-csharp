...
namespace Engage.Digital.Client.Api
{
    ...
    public partial class TimeSheetsApi : ITimeSheetsApi
    {
        ...
        /// <returns></returns>
        public TimeSheetsApi(Engage.Digital.Client.Configuration configuration)
        {
        ...
        public TimeSheetsApi(Engage.Digital.Client.ISynchronousClient client,Engage.Digital.Client.IAsynchronousClient asyncClient, Engage.Digital.Client.IReadableConfiguration configuration)
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<TimeSheet> localVarResponse = CreateTimeSheetWithHttpInfo(label, active, sourceIds, holidaysRegion, holidays, mondayHours, tuesdayHours, wednesdayHours, thursdayHours, fridayHours, saturdayHours, sundayHours);
        ...
        /// <param name="sundayHours">this field define the time intervals of the day (in secs). An empty string means that there are no business hours on this day. See &#x60;monday_hours&#x60; for the format. (optional)</param>
        /// <returns>ApiResponse of TimeSheet</returns>
        public Engage.Digital.Client.ApiResponse< TimeSheet > CreateTimeSheetWithHttpInfo (string label, bool? active = null, List<string> sourceIds = null, string holidaysRegion = null, string holidays = null, string mondayHours = null, string tuesdayHours = null, string wednesdayHours = null, string thursdayHours = null, string fridayHours = null, string saturdayHours = null, string sundayHours = null)
        {
            // verify the required parameter 'label' is set
            if (label == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'label' when calling TimeSheetsApi->CreateTimeSheet");
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "holidays_region", holidaysRegion))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (holidays != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "holidays", holidays))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (mondayHours != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "monday_hours", mondayHours))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "tuesday_hours", tuesdayHours))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "wednesday_hours", wednesdayHours))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "thursday_hours", thursdayHours))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (fridayHours != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "friday_hours", fridayHours))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "saturday_hours", saturdayHours))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (sundayHours != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "sunday_hours", sundayHours))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
        ...
        {
             Engage.Digital.Client.ApiResponse<TimeSheet> localVarResponse = await CreateTimeSheetAsyncWithHttpInfo(label, active, sourceIds, holidaysRegion, holidays, mondayHours, tuesdayHours, wednesdayHours, thursdayHours, fridayHours, saturdayHours, sundayHours);
             return localVarResponse.Data;
        ...
        /// <param name="sundayHours">this field define the time intervals of the day (in secs). An empty string means that there are no business hours on this day. See &#x60;monday_hours&#x60; for the format. (optional)</param>
        /// <returns>Task of ApiResponse (TimeSheet)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<TimeSheet>> CreateTimeSheetAsyncWithHttpInfo (string label, bool? active = null, List<string> sourceIds = null, string holidaysRegion = null, string holidays = null, string mondayHours = null, string tuesdayHours = null, string wednesdayHours = null, string thursdayHours = null, string fridayHours = null, string saturdayHours = null, string sundayHours = null)
        {
            // verify the required parameter 'label' is set
            if (label == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'label' when calling TimeSheetsApi->CreateTimeSheet");
        ...
        {
             Engage.Digital.Client.ApiResponse<TimeSheet> localVarResponse = DeleteTimeSheetWithHttpInfo(timeSheetId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="timeSheetId"></param>
        /// <returns>ApiResponse of TimeSheet</returns>
        public Engage.Digital.Client.ApiResponse< TimeSheet > DeleteTimeSheetWithHttpInfo (string timeSheetId)
        {
            // verify the required parameter 'timeSheetId' is set
            if (timeSheetId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'timeSheetId' when calling TimeSheetsApi->DeleteTimeSheet");
            ...
            if (timeSheetId != null)
                requestOptions.PathParameters.Add("timeSheetId", Engage.Digital.Client.ClientUtils.ParameterToString(timeSheetId)); // path parameter
        ...
        {
             Engage.Digital.Client.ApiResponse<TimeSheet> localVarResponse = await DeleteTimeSheetAsyncWithHttpInfo(timeSheetId);
             return localVarResponse.Data;
        ...
        /// <param name="timeSheetId"></param>
        /// <returns>Task of ApiResponse (TimeSheet)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<TimeSheet>> DeleteTimeSheetAsyncWithHttpInfo (string timeSheetId)
        {
            // verify the required parameter 'timeSheetId' is set
            if (timeSheetId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'timeSheetId' when calling TimeSheetsApi->DeleteTimeSheet");
        ...
        {
             Engage.Digital.Client.ApiResponse<GetAllTimeSheetsResponse> localVarResponse = GetAllTimeSheetsWithHttpInfo(offset, limit);
             return localVarResponse.Data;
        }
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>ApiResponse of GetAllTimeSheetsResponse</returns>
        public Engage.Digital.Client.ApiResponse< GetAllTimeSheetsResponse > GetAllTimeSheetsWithHttpInfo (int? offset = null, int? limit = null)
        {
            Engage.Digital.Client.RequestOptions requestOptions = new Engage.Digital.Client.RequestOptions();
        ...
        {
             Engage.Digital.Client.ApiResponse<GetAllTimeSheetsResponse> localVarResponse = await GetAllTimeSheetsAsyncWithHttpInfo(offset, limit);
             return localVarResponse.Data;
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>Task of ApiResponse (GetAllTimeSheetsResponse)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<GetAllTimeSheetsResponse>> GetAllTimeSheetsAsyncWithHttpInfo (int? offset = null, int? limit = null)
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<TimeSheet> localVarResponse = GetTimeSheetWithHttpInfo(timeSheetId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="timeSheetId"></param>
        /// <returns>ApiResponse of TimeSheet</returns>
        public Engage.Digital.Client.ApiResponse< TimeSheet > GetTimeSheetWithHttpInfo (string timeSheetId)
        {
            // verify the required parameter 'timeSheetId' is set
            if (timeSheetId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'timeSheetId' when calling TimeSheetsApi->GetTimeSheet");
        ...
        {
             Engage.Digital.Client.ApiResponse<TimeSheet> localVarResponse = await GetTimeSheetAsyncWithHttpInfo(timeSheetId);
             return localVarResponse.Data;
        ...
        /// <param name="timeSheetId"></param>
        /// <returns>Task of ApiResponse (TimeSheet)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<TimeSheet>> GetTimeSheetAsyncWithHttpInfo (string timeSheetId)
        {
            // verify the required parameter 'timeSheetId' is set
            if (timeSheetId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'timeSheetId' when calling TimeSheetsApi->GetTimeSheet");
        ...
        {
             Engage.Digital.Client.ApiResponse<TimeSheet> localVarResponse = UpdateTimeSheetWithHttpInfo(timeSheetId, active, label, sourceIds, holidays, mondayHours, tuesdayHours, wednesdayHours, thursdayHours, fridayHours, saturdayHours, sundayHours);
             return localVarResponse.Data;
        }
        ...
        /// <param name="sundayHours">this field define the time intervals of the day (in secs). An empty string means that there are no business hours on this day. See &#x60;monday_hours&#x60; for the format. (optional)</param>
        /// <returns>ApiResponse of TimeSheet</returns>
        public Engage.Digital.Client.ApiResponse< TimeSheet > UpdateTimeSheetWithHttpInfo (string timeSheetId, bool? active = null, string label = null, List<string> sourceIds = null, string holidays = null, string mondayHours = null, string tuesdayHours = null, string wednesdayHours = null, string thursdayHours = null, string fridayHours = null, string saturdayHours = null, string sundayHours = null)
        {
            // verify the required parameter 'timeSheetId' is set
            if (timeSheetId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'timeSheetId' when calling TimeSheetsApi->UpdateTimeSheet");
        ...
        {
             Engage.Digital.Client.ApiResponse<TimeSheet> localVarResponse = await UpdateTimeSheetAsyncWithHttpInfo(timeSheetId, active, label, sourceIds, holidays, mondayHours, tuesdayHours, wednesdayHours, thursdayHours, fridayHours, saturdayHours, sundayHours);
             return localVarResponse.Data;
        ...
        /// <param name="sundayHours">this field define the time intervals of the day (in secs). An empty string means that there are no business hours on this day. See &#x60;monday_hours&#x60; for the format. (optional)</param>
        /// <returns>Task of ApiResponse (TimeSheet)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<TimeSheet>> UpdateTimeSheetAsyncWithHttpInfo (string timeSheetId, bool? active = null, string label = null, List<string> sourceIds = null, string holidays = null, string mondayHours = null, string tuesdayHours = null, string wednesdayHours = null, string thursdayHours = null, string fridayHours = null, string saturdayHours = null, string sundayHours = null)
        {
            // verify the required parameter 'timeSheetId' is set
            if (timeSheetId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'timeSheetId' when calling TimeSheetsApi->UpdateTimeSheet");
