...
namespace Engage.Digital.Client.Api
{
    ...
    public partial class IdentityGroupsApi : IIdentityGroupsApi
    {
        ...
        /// <returns></returns>
        public IdentityGroupsApi(Engage.Digital.Client.Configuration configuration)
        {
        ...
        public IdentityGroupsApi(Engage.Digital.Client.ISynchronousClient client,Engage.Digital.Client.IAsynchronousClient asyncClient, Engage.Digital.Client.IReadableConfiguration configuration)
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<GetAllIdentityGroupsResponse> localVarResponse = GetAllIdentityGroupsWithHttpInfo(firstname, lastname, email, uuid, sort, offset, limit);
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>ApiResponse of GetAllIdentityGroupsResponse</returns>
        public Engage.Digital.Client.ApiResponse< GetAllIdentityGroupsResponse > GetAllIdentityGroupsWithHttpInfo (string firstname = null, string lastname = null, string email = null, string uuid = null, string sort = null, int? offset = null, int? limit = null)
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<GetAllIdentityGroupsResponse> localVarResponse = await GetAllIdentityGroupsAsyncWithHttpInfo(firstname, lastname, email, uuid, sort, offset, limit);
             return localVarResponse.Data;
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>Task of ApiResponse (GetAllIdentityGroupsResponse)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<GetAllIdentityGroupsResponse>> GetAllIdentityGroupsAsyncWithHttpInfo (string firstname = null, string lastname = null, string email = null, string uuid = null, string sort = null, int? offset = null, int? limit = null)
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<IdentityGroup> localVarResponse = GetIdentityGroupWithHttpInfo(identityGroupId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="identityGroupId"></param>
        /// <returns>ApiResponse of IdentityGroup</returns>
        public Engage.Digital.Client.ApiResponse< IdentityGroup > GetIdentityGroupWithHttpInfo (string identityGroupId)
        {
            // verify the required parameter 'identityGroupId' is set
            if (identityGroupId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'identityGroupId' when calling IdentityGroupsApi->GetIdentityGroup");
            ...
            if (identityGroupId != null)
                requestOptions.PathParameters.Add("identityGroupId", Engage.Digital.Client.ClientUtils.ParameterToString(identityGroupId)); // path parameter
        ...
        {
             Engage.Digital.Client.ApiResponse<IdentityGroup> localVarResponse = await GetIdentityGroupAsyncWithHttpInfo(identityGroupId);
             return localVarResponse.Data;
        ...
        /// <param name="identityGroupId"></param>
        /// <returns>Task of ApiResponse (IdentityGroup)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<IdentityGroup>> GetIdentityGroupAsyncWithHttpInfo (string identityGroupId)
        {
            // verify the required parameter 'identityGroupId' is set
            if (identityGroupId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'identityGroupId' when calling IdentityGroupsApi->GetIdentityGroup");
        ...
        {
             Engage.Digital.Client.ApiResponse<IdentityGroup> localVarResponse = UpdateIdentityGroupWithHttpInfo(identityGroupId, company, customFieldValuesCustomFieldKey, emails, firstname, gender, homePhones, lastname, mobilePhones, notes, tagIds);
             return localVarResponse.Data;
        }
        ...
        /// <param name="tagIds">Identity tag ids (multiple). (optional)</param>
        /// <returns>ApiResponse of IdentityGroup</returns>
        public Engage.Digital.Client.ApiResponse< IdentityGroup > UpdateIdentityGroupWithHttpInfo (string identityGroupId, string company = null, string customFieldValuesCustomFieldKey = null, List<string> emails = null, string firstname = null, string gender = null, List<string> homePhones = null, string lastname = null, List<string> mobilePhones = null, string notes = null, List<string> tagIds = null)
        {
            // verify the required parameter 'identityGroupId' is set
            if (identityGroupId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'identityGroupId' when calling IdentityGroupsApi->UpdateIdentityGroup");
            ...
            if (company != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "company", company))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "custom_field_values[custom_field_key]", customFieldValuesCustomFieldKey))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (emails != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("multi", "emails", emails))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (homePhones != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("multi", "home_phones", homePhones))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("multi", "mobile_phones", mobilePhones))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (notes != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "notes", notes))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (tagIds != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("multi", "tag_ids", tagIds))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
        ...
        {
             Engage.Digital.Client.ApiResponse<IdentityGroup> localVarResponse = await UpdateIdentityGroupAsyncWithHttpInfo(identityGroupId, company, customFieldValuesCustomFieldKey, emails, firstname, gender, homePhones, lastname, mobilePhones, notes, tagIds);
             return localVarResponse.Data;
        ...
        /// <param name="tagIds">Identity tag ids (multiple). (optional)</param>
        /// <returns>Task of ApiResponse (IdentityGroup)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<IdentityGroup>> UpdateIdentityGroupAsyncWithHttpInfo (string identityGroupId, string company = null, string customFieldValuesCustomFieldKey = null, List<string> emails = null, string firstname = null, string gender = null, List<string> homePhones = null, string lastname = null, List<string> mobilePhones = null, string notes = null, List<string> tagIds = null)
        {
            // verify the required parameter 'identityGroupId' is set
            if (identityGroupId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'identityGroupId' when calling IdentityGroupsApi->UpdateIdentityGroup");
