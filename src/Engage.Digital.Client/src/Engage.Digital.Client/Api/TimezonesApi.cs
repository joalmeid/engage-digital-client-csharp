...
namespace Engage.Digital.Client.Api
{
    ...
    public partial class TimezonesApi : ITimezonesApi
    {
        ...
        /// <returns></returns>
        public TimezonesApi(Engage.Digital.Client.Configuration configuration)
        {
        ...
        public TimezonesApi(Engage.Digital.Client.ISynchronousClient client,Engage.Digital.Client.IAsynchronousClient asyncClient, Engage.Digital.Client.IReadableConfiguration configuration)
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<List<Timezone>> localVarResponse = GetAllTimezonesWithHttpInfo();
        ...
        /// <exception cref="Engage.Digital.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;Timezone&gt;</returns>
        public Engage.Digital.Client.ApiResponse< List<Timezone> > GetAllTimezonesWithHttpInfo ()
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<List<Timezone>> localVarResponse = await GetAllTimezonesAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="Engage.Digital.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (List&lt;Timezone&gt;)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<List<Timezone>>> GetAllTimezonesAsyncWithHttpInfo ()
        {
