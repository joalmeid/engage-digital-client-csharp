...
namespace Engage.Digital.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContentAttachment :  IEquatable<ContentAttachment>, IValidatableObject
    {
        /// <summary>
        ...
        public ContentAttachment(string contentType = default(string), DateTime createdAt = default(DateTime), string embed = default(string), string filename = default(string), string foreignId = default(string), string id = default(string), string _public = default(string), int size = default(int), DateTime updatedAt = default(DateTime), string url = default(string))
        {
