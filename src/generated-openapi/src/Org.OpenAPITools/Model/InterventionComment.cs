...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InterventionComment :  IEquatable<InterventionComment>, IValidatableObject
    {
        /// <summary>
        ...
        public InterventionComment(string body = default(string), DateTime createdAt = default(DateTime), string id = default(string), string interventionId = default(string), string threadId = default(string), DateTime updatedAt = default(DateTime), string userId = default(string), string videntityId = default(string))
        {
            this.Body = body;
