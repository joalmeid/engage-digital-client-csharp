...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ReplyAssistantEntry :  IEquatable<ReplyAssistantEntry>, IValidatableObject
    {
        ...
        public ReplyAssistantEntry(List<string> categoryIds = default(List<string>), DateTime createdAt = default(DateTime), string entryGroupId = default(string), string foreignId = default(string), string id = default(string), string label = default(string), string shortcuts = default(string), List<string> sourceIds = default(List<string>), DateTime updatedAt = default(DateTime), List<string> versionIds = default(List<string>))
        {
