...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Source :  IEquatable<Source>, IValidatableObject
    {
        ...
        public Source(bool active = default(bool), bool autoDetectContentLanguage = default(bool), string channelId = default(string), int color = default(int), string communityId = default(string), bool contentArchiving = default(bool), long contentArchivingPeriod = default(long), List<string> contentLanguages = default(List<string>), DateTime createdAt = default(DateTime), List<string> defaultCategoryIds = default(List<string>), string defaultContentLanguage = default(string), string errorMessage = default(string), bool hiddenFromStats = default(bool), string id = default(string), int interventionMessagesBoost = default(int), string name = default(string), SlaExpiredStrategyEnum? slaExpiredStrategy = default(SlaExpiredStrategyEnum?), int slaResponse = default(int), string status = default(string), List<string> timeSheetIds = default(List<string>), int transferredTasksBoost = default(int), string type = default(string), DateTime updatedAt = default(DateTime), List<string> userThreadDefaultCategoryIds = default(List<string>))
        {
            this.Active = active;
