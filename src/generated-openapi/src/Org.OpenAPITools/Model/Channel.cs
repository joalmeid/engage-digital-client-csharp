...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Channel :  IEquatable<Channel>, IValidatableObject
    {
        ...
        public Channel(DateTime createdAt = default(DateTime), int hardCapability = default(int), string id = default(string), string label = default(string), string name = default(string), int softCapability = default(int), List<string> sourceIds = default(List<string>), int taskTimeoutSeconds = default(int), DateTime updatedAt = default(DateTime))
        {
