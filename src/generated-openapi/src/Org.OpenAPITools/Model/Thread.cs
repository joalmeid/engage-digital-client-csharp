...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Thread :  IEquatable<Thread>, IValidatableObject
    {
        ...
        public Thread(List<string> categoryIds = default(List<string>), bool closed = default(bool), int contentsCount = default(int), DateTime createdAt = default(DateTime), Object extraData = default(Object), string foreignId = default(string), string id = default(string), int interventionsCount = default(int), string sourceId = default(string), List<string> threadCategoryIds = default(List<string>), string title = default(string), DateTime updatedAt = default(DateTime))
        {
