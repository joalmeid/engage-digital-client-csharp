...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class CategoriesApi : ICategoriesApi
    {
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<Category> localVarResponse = CreateCategoryWithHttpInfo(name, parentId, color, mandatory, multiple, postQualification, unselectable, sourceIds);
        ...
        /// <param name="sourceIds">List of source id. (optional)</param>
        /// <returns>ApiResponse of Category</returns>
        public Org.OpenAPITools.Client.ApiResponse< Category > CreateCategoryWithHttpInfo (string name = null, string parentId = null, int? color = null, bool? mandatory = null, bool? multiple = null, bool? postQualification = null, bool? unselectable = null, List<string> sourceIds = null)
        {
            ...
            if (parentId != null)
            {
                foreach (var kvp in Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "parent_id", parentId))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (mandatory != null)
            {
                foreach (var kvp in Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "mandatory", mandatory))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "post_qualification", postQualification))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "unselectable", unselectable))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<Category> localVarResponse = await CreateCategoryAsyncWithHttpInfo(name, parentId, color, mandatory, multiple, postQualification, unselectable, sourceIds);
             return localVarResponse.Data;
        ...
        /// <param name="sourceIds">List of source id. (optional)</param>
        /// <returns>Task of ApiResponse (Category)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<Category>> CreateCategoryAsyncWithHttpInfo (string name = null, string parentId = null, int? color = null, bool? mandatory = null, bool? multiple = null, bool? postQualification = null, bool? unselectable = null, List<string> sourceIds = null)
        {
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<Category> localVarResponse = DeleteCategoryWithHttpInfo(categoryId, takeOverCategoryId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="takeOverCategoryId">ID of a category to recategorize (optional). (optional)</param>
        /// <returns>ApiResponse of Category</returns>
        public Org.OpenAPITools.Client.ApiResponse< Category > DeleteCategoryWithHttpInfo (string categoryId, string takeOverCategoryId = null)
        {
            // verify the required parameter 'categoryId' is set
            if (categoryId == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'categoryId' when calling CategoriesApi->DeleteCategory");
            ...
            if (categoryId != null)
                requestOptions.PathParameters.Add("categoryId", Org.OpenAPITools.Client.ClientUtils.ParameterToString(categoryId)); // path parameter
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<Category> localVarResponse = await DeleteCategoryAsyncWithHttpInfo(categoryId, takeOverCategoryId);
             return localVarResponse.Data;
        ...
        /// <param name="takeOverCategoryId">ID of a category to recategorize (optional). (optional)</param>
        /// <returns>Task of ApiResponse (Category)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<Category>> DeleteCategoryAsyncWithHttpInfo (string categoryId, string takeOverCategoryId = null)
        {
            // verify the required parameter 'categoryId' is set
            if (categoryId == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'categoryId' when calling CategoriesApi->DeleteCategory");
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<GetAllCategoriesResponse> localVarResponse = GetAllCategoriesWithHttpInfo(parentId, offset, limit);
             return localVarResponse.Data;
        }
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>ApiResponse of GetAllCategoriesResponse</returns>
        public Org.OpenAPITools.Client.ApiResponse< GetAllCategoriesResponse > GetAllCategoriesWithHttpInfo (string parentId = null, int? offset = null, int? limit = null)
        {
            Org.OpenAPITools.Client.RequestOptions requestOptions = new Org.OpenAPITools.Client.RequestOptions();
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<GetAllCategoriesResponse> localVarResponse = await GetAllCategoriesAsyncWithHttpInfo(parentId, offset, limit);
             return localVarResponse.Data;
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>Task of ApiResponse (GetAllCategoriesResponse)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<GetAllCategoriesResponse>> GetAllCategoriesAsyncWithHttpInfo (string parentId = null, int? offset = null, int? limit = null)
        {
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<Category> localVarResponse = GetCategoryWithHttpInfo(categoryId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="categoryId"></param>
        /// <returns>ApiResponse of Category</returns>
        public Org.OpenAPITools.Client.ApiResponse< Category > GetCategoryWithHttpInfo (string categoryId)
        {
            // verify the required parameter 'categoryId' is set
            if (categoryId == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'categoryId' when calling CategoriesApi->GetCategory");
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<Category> localVarResponse = await GetCategoryAsyncWithHttpInfo(categoryId);
             return localVarResponse.Data;
        ...
        /// <param name="categoryId"></param>
        /// <returns>Task of ApiResponse (Category)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<Category>> GetCategoryAsyncWithHttpInfo (string categoryId)
        {
            // verify the required parameter 'categoryId' is set
            if (categoryId == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'categoryId' when calling CategoriesApi->GetCategory");
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<Category> localVarResponse = UpdateCategoryWithHttpInfo(categoryId, name, parentId, color, mandatory, multiple, postQualification, unselectable, sourceIds);
             return localVarResponse.Data;
        }
        ...
        /// <param name="sourceIds">List of source id. (optional)</param>
        /// <returns>ApiResponse of Category</returns>
        public Org.OpenAPITools.Client.ApiResponse< Category > UpdateCategoryWithHttpInfo (string categoryId, string name = null, string parentId = null, int? color = null, bool? mandatory = null, bool? multiple = null, bool? postQualification = null, bool? unselectable = null, List<string> sourceIds = null)
        {
            // verify the required parameter 'categoryId' is set
            if (categoryId == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'categoryId' when calling CategoriesApi->UpdateCategory");
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<Category> localVarResponse = await UpdateCategoryAsyncWithHttpInfo(categoryId, name, parentId, color, mandatory, multiple, postQualification, unselectable, sourceIds);
             return localVarResponse.Data;
