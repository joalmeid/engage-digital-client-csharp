...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class ContentsApi : IContentsApi
    {
        ...
        /// <returns></returns>
        public ContentsApi(Org.OpenAPITools.Client.Configuration configuration)
        {
        ...
        public ContentsApi(Org.OpenAPITools.Client.ISynchronousClient client,Org.OpenAPITools.Client.IAsynchronousClient asyncClient, Org.OpenAPITools.Client.IReadableConfiguration configuration)
        {
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<Content> localVarResponse = CategorizeContentWithHttpInfo(contentId, categoryIds);
        ...
        /// <param name="categoryIds">An array containing the new categories to set on the content.</param>
        /// <returns>ApiResponse of Content</returns>
        public Org.OpenAPITools.Client.ApiResponse< Content > CategorizeContentWithHttpInfo (string contentId, List<string> categoryIds)
        {
            // verify the required parameter 'contentId' is set
            if (contentId == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'contentId' when calling ContentsApi->CategorizeContent");

            // verify the required parameter 'categoryIds' is set
            if (categoryIds == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'categoryIds' when calling ContentsApi->CategorizeContent");
            ...
            if (contentId != null)
                requestOptions.PathParameters.Add("contentId", Org.OpenAPITools.Client.ClientUtils.ParameterToString(contentId)); // path parameter
            if (categoryIds != null)
            {
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<Content> localVarResponse = await CategorizeContentAsyncWithHttpInfo(contentId, categoryIds);
             return localVarResponse.Data;
        ...
        /// <param name="categoryIds">An array containing the new categories to set on the content.</param>
        /// <returns>Task of ApiResponse (Content)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<Content>> CategorizeContentAsyncWithHttpInfo (string contentId, List<string> categoryIds)
        {
            // verify the required parameter 'contentId' is set
            if (contentId == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'contentId' when calling ContentsApi->CategorizeContent");
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<Content> localVarResponse = CreateContentWithHttpInfo(body, authorId, inReplyToId, _private, sourceId, attachmentIds, title, to, cc, bcc);
             return localVarResponse.Data;
        }
        ...
        /// <param name="bcc">For an email source. An array containing the email addresses used in the “Bcc” section of the email. (optional)</param>
        /// <returns>ApiResponse of Content</returns>
        public Org.OpenAPITools.Client.ApiResponse< Content > CreateContentWithHttpInfo (string body, string authorId = null, string inReplyToId = null, int? _private = null, string sourceId = null, List<string> attachmentIds = null, string title = null, List<string> to = null, List<string> cc = null, List<string> bcc = null)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'body' when calling ContentsApi->CreateContent");
            ...
            if (authorId != null)
            {
                foreach (var kvp in Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "author_id", authorId))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (inReplyToId != null)
            {
                foreach (var kvp in Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "in_reply_to_id", inReplyToId))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (_private != null)
            {
                foreach (var kvp in Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "private", _private))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (sourceId != null)
            {
                foreach (var kvp in Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "source_id", sourceId))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("multi", "attachment_ids[]", attachmentIds))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (title != null)
            {
                foreach (var kvp in Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "title", title))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (to != null)
            {
                foreach (var kvp in Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("multi", "to[]", to))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (cc != null)
            {
                foreach (var kvp in Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("multi", "cc[]", cc))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (bcc != null)
            {
                foreach (var kvp in Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("multi", "bcc[]", bcc))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<Content> localVarResponse = await CreateContentAsyncWithHttpInfo(body, authorId, inReplyToId, _private, sourceId, attachmentIds, title, to, cc, bcc);
             return localVarResponse.Data;
        ...
        /// <param name="bcc">For an email source. An array containing the email addresses used in the “Bcc” section of the email. (optional)</param>
        /// <returns>Task of ApiResponse (Content)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<Content>> CreateContentAsyncWithHttpInfo (string body, string authorId = null, string inReplyToId = null, int? _private = null, string sourceId = null, List<string> attachmentIds = null, string title = null, List<string> to = null, List<string> cc = null, List<string> bcc = null)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'body' when calling ContentsApi->CreateContent");
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<GetAllContentsResponse> localVarResponse = GetAllContentsWithHttpInfo(q, offset, limit);
             return localVarResponse.Data;
        }
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>ApiResponse of GetAllContentsResponse</returns>
        public Org.OpenAPITools.Client.ApiResponse< GetAllContentsResponse > GetAllContentsWithHttpInfo (string q = null, int? offset = null, int? limit = null)
        {
            Org.OpenAPITools.Client.RequestOptions requestOptions = new Org.OpenAPITools.Client.RequestOptions();
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<GetAllContentsResponse> localVarResponse = await GetAllContentsAsyncWithHttpInfo(q, offset, limit);
             return localVarResponse.Data;
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>Task of ApiResponse (GetAllContentsResponse)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<GetAllContentsResponse>> GetAllContentsAsyncWithHttpInfo (string q = null, int? offset = null, int? limit = null)
        {
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<Content> localVarResponse = GetContentWithHttpInfo(contentId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="contentId"></param>
        /// <returns>ApiResponse of Content</returns>
        public Org.OpenAPITools.Client.ApiResponse< Content > GetContentWithHttpInfo (string contentId)
        {
            // verify the required parameter 'contentId' is set
            if (contentId == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'contentId' when calling ContentsApi->GetContent");
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<Content> localVarResponse = await GetContentAsyncWithHttpInfo(contentId);
             return localVarResponse.Data;
        ...
        /// <param name="contentId"></param>
        /// <returns>Task of ApiResponse (Content)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<Content>> GetContentAsyncWithHttpInfo (string contentId)
        {
            // verify the required parameter 'contentId' is set
            if (contentId == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'contentId' when calling ContentsApi->GetContent");
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<Content> localVarResponse = IgnoreContentWithHttpInfo(contentId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="contentId"></param>
        /// <returns>ApiResponse of Content</returns>
        public Org.OpenAPITools.Client.ApiResponse< Content > IgnoreContentWithHttpInfo (string contentId)
        {
            // verify the required parameter 'contentId' is set
            if (contentId == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'contentId' when calling ContentsApi->IgnoreContent");
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<Content> localVarResponse = await IgnoreContentAsyncWithHttpInfo(contentId);
             return localVarResponse.Data;
        ...
        /// <param name="contentId"></param>
        /// <returns>Task of ApiResponse (Content)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<Content>> IgnoreContentAsyncWithHttpInfo (string contentId)
        {
            // verify the required parameter 'contentId' is set
            if (contentId == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'contentId' when calling ContentsApi->IgnoreContent");
