...
namespace Engage.Digital.Model
{
    ...
    public partial class Team :  IEquatable<Team>, IValidatableObject
    {
        ...
        public Team(DateTime createdAt = default(DateTime), string id = default(string), List<string> leaderIds = default(List<string>), string name = default(string), DateTime updatedAt = default(DateTime), List<string> userIds = default(List<string>))
        {
