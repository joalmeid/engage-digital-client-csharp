...
namespace Engage.Digital.Client.Api
{
    ...
    public partial class TagsApi : ITagsApi
    {
        ...
        /// <returns></returns>
        public TagsApi(Engage.Digital.Client.Configuration configuration)
        {
        ...
        public TagsApi(Engage.Digital.Client.ISynchronousClient client,Engage.Digital.Client.IAsynchronousClient asyncClient, Engage.Digital.Client.IReadableConfiguration configuration)
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<Tag> localVarResponse = CreateTagWithHttpInfo(name);
        ...
        /// <param name="name">Tag name (mandatory).</param>
        /// <returns>ApiResponse of Tag</returns>
        public Engage.Digital.Client.ApiResponse< Tag > CreateTagWithHttpInfo (string name)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'name' when calling TagsApi->CreateTag");
        ...
        {
             Engage.Digital.Client.ApiResponse<Tag> localVarResponse = await CreateTagAsyncWithHttpInfo(name);
             return localVarResponse.Data;
        ...
        /// <param name="name">Tag name (mandatory).</param>
        /// <returns>Task of ApiResponse (Tag)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<Tag>> CreateTagAsyncWithHttpInfo (string name)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'name' when calling TagsApi->CreateTag");
        ...
        {
             Engage.Digital.Client.ApiResponse<Tag> localVarResponse = DeleteTagWithHttpInfo(tagId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="tagId"></param>
        /// <returns>ApiResponse of Tag</returns>
        public Engage.Digital.Client.ApiResponse< Tag > DeleteTagWithHttpInfo (string tagId)
        {
            // verify the required parameter 'tagId' is set
            if (tagId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'tagId' when calling TagsApi->DeleteTag");
            ...
            if (tagId != null)
                requestOptions.PathParameters.Add("tagId", Engage.Digital.Client.ClientUtils.ParameterToString(tagId)); // path parameter
        ...
        {
             Engage.Digital.Client.ApiResponse<Tag> localVarResponse = await DeleteTagAsyncWithHttpInfo(tagId);
             return localVarResponse.Data;
        ...
        /// <param name="tagId"></param>
        /// <returns>Task of ApiResponse (Tag)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<Tag>> DeleteTagAsyncWithHttpInfo (string tagId)
        {
            // verify the required parameter 'tagId' is set
            if (tagId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'tagId' when calling TagsApi->DeleteTag");
        ...
        {
             Engage.Digital.Client.ApiResponse<GetAllTagsResponse> localVarResponse = GetAllTagsWithHttpInfo(offset, limit);
             return localVarResponse.Data;
        }
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>ApiResponse of GetAllTagsResponse</returns>
        public Engage.Digital.Client.ApiResponse< GetAllTagsResponse > GetAllTagsWithHttpInfo (int? offset = null, int? limit = null)
        {
            Engage.Digital.Client.RequestOptions requestOptions = new Engage.Digital.Client.RequestOptions();
        ...
        {
             Engage.Digital.Client.ApiResponse<GetAllTagsResponse> localVarResponse = await GetAllTagsAsyncWithHttpInfo(offset, limit);
             return localVarResponse.Data;
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>Task of ApiResponse (GetAllTagsResponse)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<GetAllTagsResponse>> GetAllTagsAsyncWithHttpInfo (int? offset = null, int? limit = null)
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<Tag> localVarResponse = GetTagWithHttpInfo(tagId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="tagId"></param>
        /// <returns>ApiResponse of Tag</returns>
        public Engage.Digital.Client.ApiResponse< Tag > GetTagWithHttpInfo (string tagId)
        {
            // verify the required parameter 'tagId' is set
            if (tagId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'tagId' when calling TagsApi->GetTag");
        ...
        {
             Engage.Digital.Client.ApiResponse<Tag> localVarResponse = await GetTagAsyncWithHttpInfo(tagId);
             return localVarResponse.Data;
        ...
        /// <param name="tagId"></param>
        /// <returns>Task of ApiResponse (Tag)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<Tag>> GetTagAsyncWithHttpInfo (string tagId)
        {
            // verify the required parameter 'tagId' is set
            if (tagId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'tagId' when calling TagsApi->GetTag");
        ...
        {
             Engage.Digital.Client.ApiResponse<Tag> localVarResponse = UpdateTagWithHttpInfo(tagId, name);
             return localVarResponse.Data;
        }
        ...
        /// <param name="name">Tag’s label.</param>
        /// <returns>ApiResponse of Tag</returns>
        public Engage.Digital.Client.ApiResponse< Tag > UpdateTagWithHttpInfo (string tagId, string name)
        {
            // verify the required parameter 'tagId' is set
            if (tagId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'tagId' when calling TagsApi->UpdateTag");

            // verify the required parameter 'name' is set
            if (name == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'name' when calling TagsApi->UpdateTag");
        ...
        {
             Engage.Digital.Client.ApiResponse<Tag> localVarResponse = await UpdateTagAsyncWithHttpInfo(tagId, name);
             return localVarResponse.Data;
        ...
        /// <param name="name">Tag’s label.</param>
        /// <returns>Task of ApiResponse (Tag)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<Tag>> UpdateTagAsyncWithHttpInfo (string tagId, string name)
        {
            // verify the required parameter 'tagId' is set
            if (tagId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'tagId' when calling TagsApi->UpdateTag");
