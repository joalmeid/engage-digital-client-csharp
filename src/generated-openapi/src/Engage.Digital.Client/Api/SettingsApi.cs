...
namespace Engage.Digital.Client.Api
{
    ...
    public partial class SettingsApi : ISettingsApi
    {
        ...
        /// <returns></returns>
        public SettingsApi(Engage.Digital.Client.Configuration configuration)
        {
        ...
        public SettingsApi(Engage.Digital.Client.ISynchronousClient client,Engage.Digital.Client.IAsynchronousClient asyncClient, Engage.Digital.Client.IReadableConfiguration configuration)
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<Settings> localVarResponse = GetAllSettingsWithHttpInfo();
        ...
        /// <exception cref="Engage.Digital.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Settings</returns>
        public Engage.Digital.Client.ApiResponse< Settings > GetAllSettingsWithHttpInfo ()
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<Settings> localVarResponse = await GetAllSettingsAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="Engage.Digital.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (Settings)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<Settings>> GetAllSettingsAsyncWithHttpInfo ()
        {
        ...
        /// <param name="useSystemFont">Experimental (Boolean) (optional)</param>
        /// <returns>ApiResponse of Settings</returns>
        public Engage.Digital.Client.ApiResponse< Settings > UpdateSettingsWithHttpInfo (int? activityPresenceThreshold = null, bool? activityTracking = null, string beginningOfWeek = null, bool? categoryTagging = null, string contentLanguages = null, bool? dashboard = null, bool? denyIframeIntegration = null, bool? disablePasswordAutocomplete = null, int? expirePasswordAfter = null, bool? expirePasswordEnabled = null, bool? exportInSeconds = null, bool? foldUselessContents = null, int? fteDuration = null, bool? identityMerge = null, List<int> interventionDeferRates = null, int? interventionDeferThreshold = null, List<int> interventionRates = null, string locale = null, bool? multiLang = null, string name = null, bool? passwordArchivableEnabled = null, int? passwordArchivableSize = null, int? passwordMinLength = null, bool? passwordNonWord = null, bool? passwordNumbers = null, bool? passwordRecoveryDisabled = null, bool? pushEnabled = null, bool? replyAsAnyIdentity = null, bool? rtlSupport = null, bool? selfApprovalRequired = null, int? sessionTimeout = null, bool? spellchecking = null, string style = null, bool? thirdPartyServicesDisabled = null, string timezone = null, bool? trackJs = null, string type = null, int? urgentTaskThreshold = null, bool? useSystemFont = null)
        {
            Engage.Digital.Client.RequestOptions requestOptions = new Engage.Digital.Client.RequestOptions();
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "activity_presence_threshold", activityPresenceThreshold))
                {
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "activity_tracking", activityTracking))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "beginning_of_week", beginningOfWeek))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "category_tagging", categoryTagging))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "content_languages", contentLanguages))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (dashboard != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "dashboard", dashboard))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "deny_iframe_integration", denyIframeIntegration))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "disable_password_autocomplete", disablePasswordAutocomplete))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "expire_password_after", expirePasswordAfter))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "expire_password_enabled", expirePasswordEnabled))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "export_in_seconds", exportInSeconds))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "fold_useless_contents", foldUselessContents))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (fteDuration != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "fte_duration", fteDuration))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "identity_merge", identityMerge))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("multi", "intervention_defer_rates[]", interventionDeferRates))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "intervention_defer_threshold", interventionDeferThreshold))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("multi", "intervention_rates", interventionRates))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (multiLang != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "multi_lang", multiLang))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "password_archivable_enabled", passwordArchivableEnabled))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "password_archivable_size", passwordArchivableSize))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "password_min_length", passwordMinLength))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "password_non_word", passwordNonWord))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "password_numbers", passwordNumbers))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "password_recovery_disabled", passwordRecoveryDisabled))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (pushEnabled != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "push_enabled", pushEnabled))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "reply_as_any_identity", replyAsAnyIdentity))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (rtlSupport != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "rtl_support", rtlSupport))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "self_approval_required", selfApprovalRequired))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "session_timeout", sessionTimeout))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "spellchecking", spellchecking))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (style != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "style", style))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "third_party_services_disabled", thirdPartyServicesDisabled))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (trackJs != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "track_js", trackJs))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "urgent_task_threshold", urgentTaskThreshold))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "use_system_font", useSystemFont))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
        ...
        /// <param name="useSystemFont">Experimental (Boolean) (optional)</param>
        /// <returns>Task of ApiResponse (Settings)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<Settings>> UpdateSettingsAsyncWithHttpInfo (int? activityPresenceThreshold = null, bool? activityTracking = null, string beginningOfWeek = null, bool? categoryTagging = null, string contentLanguages = null, bool? dashboard = null, bool? denyIframeIntegration = null, bool? disablePasswordAutocomplete = null, int? expirePasswordAfter = null, bool? expirePasswordEnabled = null, bool? exportInSeconds = null, bool? foldUselessContents = null, int? fteDuration = null, bool? identityMerge = null, List<int> interventionDeferRates = null, int? interventionDeferThreshold = null, List<int> interventionRates = null, string locale = null, bool? multiLang = null, string name = null, bool? passwordArchivableEnabled = null, int? passwordArchivableSize = null, int? passwordMinLength = null, bool? passwordNonWord = null, bool? passwordNumbers = null, bool? passwordRecoveryDisabled = null, bool? pushEnabled = null, bool? replyAsAnyIdentity = null, bool? rtlSupport = null, bool? selfApprovalRequired = null, int? sessionTimeout = null, bool? spellchecking = null, string style = null, bool? thirdPartyServicesDisabled = null, string timezone = null, bool? trackJs = null, string type = null, int? urgentTaskThreshold = null, bool? useSystemFont = null)
        {
