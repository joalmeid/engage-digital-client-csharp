...
namespace Engage.Digital.Client.Api
{
    ...
    public partial class TasksApi : ITasksApi
    {
        ...
        /// <returns></returns>
        public TasksApi(Engage.Digital.Client.Configuration configuration)
        {
        ...
        public TasksApi(Engage.Digital.Client.ISynchronousClient client,Engage.Digital.Client.IAsynchronousClient asyncClient, Engage.Digital.Client.IReadableConfiguration configuration)
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<GetAllTasksResponse> localVarResponse = GetAllTasksWithHttpInfo(queue, channelId, step, offset, limit);
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>ApiResponse of GetAllTasksResponse</returns>
        public Engage.Digital.Client.ApiResponse< GetAllTasksResponse > GetAllTasksWithHttpInfo (string queue = null, string channelId = null, string step = null, int? offset = null, int? limit = null)
        {
            ...
            if (queue != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "queue", queue))
                {
            ...
            if (step != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "step", step))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
        ...
        {
             Engage.Digital.Client.ApiResponse<GetAllTasksResponse> localVarResponse = await GetAllTasksAsyncWithHttpInfo(queue, channelId, step, offset, limit);
             return localVarResponse.Data;
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>Task of ApiResponse (GetAllTasksResponse)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<GetAllTasksResponse>> GetAllTasksAsyncWithHttpInfo (string queue = null, string channelId = null, string step = null, int? offset = null, int? limit = null)
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<Task> localVarResponse = GetTaskWithHttpInfo(taskId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="taskId"></param>
        /// <returns>ApiResponse of Task</returns>
        public Engage.Digital.Client.ApiResponse< Task > GetTaskWithHttpInfo (string taskId)
        {
            // verify the required parameter 'taskId' is set
            if (taskId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'taskId' when calling TasksApi->GetTask");
            ...
            if (taskId != null)
                requestOptions.PathParameters.Add("taskId", Engage.Digital.Client.ClientUtils.ParameterToString(taskId)); // path parameter
        ...
        {
             Engage.Digital.Client.ApiResponse<Task> localVarResponse = await GetTaskAsyncWithHttpInfo(taskId);
             return localVarResponse.Data;
        ...
        /// <param name="taskId"></param>
        /// <returns>Task of ApiResponse (Task)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<Task>> GetTaskAsyncWithHttpInfo (string taskId)
        {
            // verify the required parameter 'taskId' is set
            if (taskId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'taskId' when calling TasksApi->GetTask");
        ...
        {
             Engage.Digital.Client.ApiResponse<Task> localVarResponse = MoveTaskWithHttpInfo(taskId, queue);
             return localVarResponse.Data;
        }
        ...
        /// <param name="queue">Name of the queue task has to be moved in.</param>
        /// <returns>ApiResponse of Task</returns>
        public Engage.Digital.Client.ApiResponse< Task > MoveTaskWithHttpInfo (string taskId, string queue)
        {
            // verify the required parameter 'taskId' is set
            if (taskId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'taskId' when calling TasksApi->MoveTask");

            // verify the required parameter 'queue' is set
            if (queue == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'queue' when calling TasksApi->MoveTask");
        ...
        {
             Engage.Digital.Client.ApiResponse<Task> localVarResponse = await MoveTaskAsyncWithHttpInfo(taskId, queue);
             return localVarResponse.Data;
        ...
        /// <param name="queue">Name of the queue task has to be moved in.</param>
        /// <returns>Task of ApiResponse (Task)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<Task>> MoveTaskAsyncWithHttpInfo (string taskId, string queue)
        {
            // verify the required parameter 'taskId' is set
            if (taskId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'taskId' when calling TasksApi->MoveTask");
        ...
        {
             Engage.Digital.Client.ApiResponse<Task> localVarResponse = TransferTaskWithHttpInfo(taskId, agentIds, bypass, categoryIds, language, teamIds, comment);
             return localVarResponse.Data;
        }
        ...
        /// <param name="comment">Add a comment to the task. (optional)</param>
        /// <returns>ApiResponse of Task</returns>
        public Engage.Digital.Client.ApiResponse< Task > TransferTaskWithHttpInfo (string taskId, List<string> agentIds = null, string bypass = null, List<string> categoryIds = null, string language = null, List<string> teamIds = null, string comment = null)
        {
            // verify the required parameter 'taskId' is set
            if (taskId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'taskId' when calling TasksApi->TransferTask");
            ...
            if (agentIds != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("multi", "agent_ids", agentIds))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (bypass != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "bypass", bypass))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            if (comment != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "comment", comment))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
        ...
        {
             Engage.Digital.Client.ApiResponse<Task> localVarResponse = await TransferTaskAsyncWithHttpInfo(taskId, agentIds, bypass, categoryIds, language, teamIds, comment);
             return localVarResponse.Data;
        ...
        /// <param name="comment">Add a comment to the task. (optional)</param>
        /// <returns>Task of ApiResponse (Task)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<Task>> TransferTaskAsyncWithHttpInfo (string taskId, List<string> agentIds = null, string bypass = null, List<string> categoryIds = null, string language = null, List<string> teamIds = null, string comment = null)
        {
            // verify the required parameter 'taskId' is set
            if (taskId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'taskId' when calling TasksApi->TransferTask");
