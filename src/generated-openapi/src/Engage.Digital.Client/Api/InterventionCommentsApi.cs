...
namespace Engage.Digital.Client.Api
{
    ...
    public partial class InterventionCommentsApi : IInterventionCommentsApi
    {
        ...
        /// <returns></returns>
        public InterventionCommentsApi(Engage.Digital.Client.Configuration configuration)
        {
        ...
        public InterventionCommentsApi(Engage.Digital.Client.ISynchronousClient client,Engage.Digital.Client.IAsynchronousClient asyncClient, Engage.Digital.Client.IReadableConfiguration configuration)
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<InterventionComment> localVarResponse = CreateInterventionCommentWithHttpInfo(body, interventionId, userId);
        ...
        /// <param name="userId">The comment user id (mandatory).</param>
        /// <returns>ApiResponse of InterventionComment</returns>
        public Engage.Digital.Client.ApiResponse< InterventionComment > CreateInterventionCommentWithHttpInfo (string body, string interventionId, string userId)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'body' when calling InterventionCommentsApi->CreateInterventionComment");

            // verify the required parameter 'interventionId' is set
            if (interventionId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'interventionId' when calling InterventionCommentsApi->CreateInterventionComment");

            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'userId' when calling InterventionCommentsApi->CreateInterventionComment");
            ...
            if (interventionId != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "intervention_id", interventionId))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
        ...
        {
             Engage.Digital.Client.ApiResponse<InterventionComment> localVarResponse = await CreateInterventionCommentAsyncWithHttpInfo(body, interventionId, userId);
             return localVarResponse.Data;
        ...
        /// <param name="userId">The comment user id (mandatory).</param>
        /// <returns>Task of ApiResponse (InterventionComment)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<InterventionComment>> CreateInterventionCommentAsyncWithHttpInfo (string body, string interventionId, string userId)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'body' when calling InterventionCommentsApi->CreateInterventionComment");
        ...
        {
             Engage.Digital.Client.ApiResponse<InterventionComment> localVarResponse = DeleteInterventionCommentWithHttpInfo(interventionCommentId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="interventionCommentId"></param>
        /// <returns>ApiResponse of InterventionComment</returns>
        public Engage.Digital.Client.ApiResponse< InterventionComment > DeleteInterventionCommentWithHttpInfo (string interventionCommentId)
        {
            // verify the required parameter 'interventionCommentId' is set
            if (interventionCommentId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'interventionCommentId' when calling InterventionCommentsApi->DeleteInterventionComment");
            ...
            if (interventionCommentId != null)
                requestOptions.PathParameters.Add("interventionCommentId", Engage.Digital.Client.ClientUtils.ParameterToString(interventionCommentId)); // path parameter
        ...
        {
             Engage.Digital.Client.ApiResponse<InterventionComment> localVarResponse = await DeleteInterventionCommentAsyncWithHttpInfo(interventionCommentId);
             return localVarResponse.Data;
        ...
        /// <param name="interventionCommentId"></param>
        /// <returns>Task of ApiResponse (InterventionComment)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<InterventionComment>> DeleteInterventionCommentAsyncWithHttpInfo (string interventionCommentId)
        {
            // verify the required parameter 'interventionCommentId' is set
            if (interventionCommentId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'interventionCommentId' when calling InterventionCommentsApi->DeleteInterventionComment");
        ...
        {
             Engage.Digital.Client.ApiResponse<GetAllInterventionCommentsResponse> localVarResponse = GetAllInterventionCommentsWithHttpInfo(interventionId, threadId, userId, identityId, offset, limit);
             return localVarResponse.Data;
        }
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>ApiResponse of GetAllInterventionCommentsResponse</returns>
        public Engage.Digital.Client.ApiResponse< GetAllInterventionCommentsResponse > GetAllInterventionCommentsWithHttpInfo (string interventionId = null, string threadId = null, string userId = null, string identityId = null, int? offset = null, int? limit = null)
        {
            Engage.Digital.Client.RequestOptions requestOptions = new Engage.Digital.Client.RequestOptions();
        ...
        {
             Engage.Digital.Client.ApiResponse<GetAllInterventionCommentsResponse> localVarResponse = await GetAllInterventionCommentsAsyncWithHttpInfo(interventionId, threadId, userId, identityId, offset, limit);
             return localVarResponse.Data;
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>Task of ApiResponse (GetAllInterventionCommentsResponse)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<GetAllInterventionCommentsResponse>> GetAllInterventionCommentsAsyncWithHttpInfo (string interventionId = null, string threadId = null, string userId = null, string identityId = null, int? offset = null, int? limit = null)
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<InterventionComment> localVarResponse = GetInterventionCommentWithHttpInfo(interventionCommentId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="interventionCommentId"></param>
        /// <returns>ApiResponse of InterventionComment</returns>
        public Engage.Digital.Client.ApiResponse< InterventionComment > GetInterventionCommentWithHttpInfo (string interventionCommentId)
        {
            // verify the required parameter 'interventionCommentId' is set
            if (interventionCommentId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'interventionCommentId' when calling InterventionCommentsApi->GetInterventionComment");
        ...
        {
             Engage.Digital.Client.ApiResponse<InterventionComment> localVarResponse = await GetInterventionCommentAsyncWithHttpInfo(interventionCommentId);
             return localVarResponse.Data;
        ...
        /// <param name="interventionCommentId"></param>
        /// <returns>Task of ApiResponse (InterventionComment)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<InterventionComment>> GetInterventionCommentAsyncWithHttpInfo (string interventionCommentId)
        {
            // verify the required parameter 'interventionCommentId' is set
            if (interventionCommentId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'interventionCommentId' when calling InterventionCommentsApi->GetInterventionComment");
