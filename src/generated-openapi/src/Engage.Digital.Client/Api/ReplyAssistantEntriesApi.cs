...
namespace Engage.Digital.Client.Api
{
    ...
    public partial class ReplyAssistantEntriesApi : IReplyAssistantEntriesApi
    {
        ...
        /// <returns></returns>
        public ReplyAssistantEntriesApi(Engage.Digital.Client.Configuration configuration)
        {
        ...
        public ReplyAssistantEntriesApi(Engage.Digital.Client.ISynchronousClient client,Engage.Digital.Client.IAsynchronousClient asyncClient, Engage.Digital.Client.IReadableConfiguration configuration)
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<ReplyAssistantEntry> localVarResponse = CreateReplyAssistantEntryWithHttpInfo(label);
        ...
        /// <param name="label">The name of the entry.</param>
        /// <returns>ApiResponse of ReplyAssistantEntry</returns>
        public Engage.Digital.Client.ApiResponse< ReplyAssistantEntry > CreateReplyAssistantEntryWithHttpInfo (string label)
        {
            // verify the required parameter 'label' is set
            if (label == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'label' when calling ReplyAssistantEntriesApi->CreateReplyAssistantEntry");
        ...
        {
             Engage.Digital.Client.ApiResponse<ReplyAssistantEntry> localVarResponse = await CreateReplyAssistantEntryAsyncWithHttpInfo(label);
             return localVarResponse.Data;
        ...
        /// <param name="label">The name of the entry.</param>
        /// <returns>Task of ApiResponse (ReplyAssistantEntry)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<ReplyAssistantEntry>> CreateReplyAssistantEntryAsyncWithHttpInfo (string label)
        {
            // verify the required parameter 'label' is set
            if (label == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'label' when calling ReplyAssistantEntriesApi->CreateReplyAssistantEntry");
        ...
        {
             Engage.Digital.Client.ApiResponse<ReplyAssistantEntry> localVarResponse = DeleteReplyAssistantEntryWithHttpInfo(replyAssistantEntryId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="replyAssistantEntryId"></param>
        /// <returns>ApiResponse of ReplyAssistantEntry</returns>
        public Engage.Digital.Client.ApiResponse< ReplyAssistantEntry > DeleteReplyAssistantEntryWithHttpInfo (string replyAssistantEntryId)
        {
            // verify the required parameter 'replyAssistantEntryId' is set
            if (replyAssistantEntryId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'replyAssistantEntryId' when calling ReplyAssistantEntriesApi->DeleteReplyAssistantEntry");
            ...
            if (replyAssistantEntryId != null)
                requestOptions.PathParameters.Add("replyAssistantEntryId", Engage.Digital.Client.ClientUtils.ParameterToString(replyAssistantEntryId)); // path parameter
        ...
        {
             Engage.Digital.Client.ApiResponse<ReplyAssistantEntry> localVarResponse = await DeleteReplyAssistantEntryAsyncWithHttpInfo(replyAssistantEntryId);
             return localVarResponse.Data;
        ...
        /// <param name="replyAssistantEntryId"></param>
        /// <returns>Task of ApiResponse (ReplyAssistantEntry)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<ReplyAssistantEntry>> DeleteReplyAssistantEntryAsyncWithHttpInfo (string replyAssistantEntryId)
        {
            // verify the required parameter 'replyAssistantEntryId' is set
            if (replyAssistantEntryId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'replyAssistantEntryId' when calling ReplyAssistantEntriesApi->DeleteReplyAssistantEntry");
        ...
        {
             Engage.Digital.Client.ApiResponse<GetAllReplyAssistantEntriesResponse> localVarResponse = GetAllReplyAssistantEntriesWithHttpInfo(offset, limit);
             return localVarResponse.Data;
        }
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>ApiResponse of GetAllReplyAssistantEntriesResponse</returns>
        public Engage.Digital.Client.ApiResponse< GetAllReplyAssistantEntriesResponse > GetAllReplyAssistantEntriesWithHttpInfo (int? offset = null, int? limit = null)
        {
            Engage.Digital.Client.RequestOptions requestOptions = new Engage.Digital.Client.RequestOptions();
        ...
        {
             Engage.Digital.Client.ApiResponse<GetAllReplyAssistantEntriesResponse> localVarResponse = await GetAllReplyAssistantEntriesAsyncWithHttpInfo(offset, limit);
             return localVarResponse.Data;
        ...
        /// <param name="limit">The max number of records to return. Default value is 30, max value is 150. (optional)</param>
        /// <returns>Task of ApiResponse (GetAllReplyAssistantEntriesResponse)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<GetAllReplyAssistantEntriesResponse>> GetAllReplyAssistantEntriesAsyncWithHttpInfo (int? offset = null, int? limit = null)
        {
        ...
        {
             Engage.Digital.Client.ApiResponse<ReplyAssistantEntry> localVarResponse = GetReplyAssistantEntryWithHttpInfo(replyAssistantEntryId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="replyAssistantEntryId"></param>
        /// <returns>ApiResponse of ReplyAssistantEntry</returns>
        public Engage.Digital.Client.ApiResponse< ReplyAssistantEntry > GetReplyAssistantEntryWithHttpInfo (string replyAssistantEntryId)
        {
            // verify the required parameter 'replyAssistantEntryId' is set
            if (replyAssistantEntryId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'replyAssistantEntryId' when calling ReplyAssistantEntriesApi->GetReplyAssistantEntry");
        ...
        {
             Engage.Digital.Client.ApiResponse<ReplyAssistantEntry> localVarResponse = await GetReplyAssistantEntryAsyncWithHttpInfo(replyAssistantEntryId);
             return localVarResponse.Data;
        ...
        /// <param name="replyAssistantEntryId"></param>
        /// <returns>Task of ApiResponse (ReplyAssistantEntry)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<ReplyAssistantEntry>> GetReplyAssistantEntryAsyncWithHttpInfo (string replyAssistantEntryId)
        {
            // verify the required parameter 'replyAssistantEntryId' is set
            if (replyAssistantEntryId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'replyAssistantEntryId' when calling ReplyAssistantEntriesApi->GetReplyAssistantEntry");
        ...
        {
             Engage.Digital.Client.ApiResponse<ReplyAssistantEntry> localVarResponse = UpdateReplyAssistantEntryWithHttpInfo(replyAssistantEntryId, label, foreignId, categoryIds, shortcuts, entryGroupId, sourceIds);
             return localVarResponse.Data;
        }
        ...
        /// <param name="sourceIds">Source ids (array) (optional)</param>
        /// <returns>ApiResponse of ReplyAssistantEntry</returns>
        public Engage.Digital.Client.ApiResponse< ReplyAssistantEntry > UpdateReplyAssistantEntryWithHttpInfo (string replyAssistantEntryId, string label = null, string foreignId = null, List<string> categoryIds = null, List<string> shortcuts = null, string entryGroupId = null, List<string> sourceIds = null)
        {
            // verify the required parameter 'replyAssistantEntryId' is set
            if (replyAssistantEntryId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'replyAssistantEntryId' when calling ReplyAssistantEntriesApi->UpdateReplyAssistantEntry");
            ...
            if (shortcuts != null)
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("multi", "shortcuts[]", shortcuts))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
            ...
            {
                foreach (var kvp in Engage.Digital.Client.ClientUtils.ParameterToMultiMap("", "entry_group_id", entryGroupId))
                {
                    foreach (var value in kvp.Value)
                    {
                        requestOptions.QueryParameters.Add(kvp.Key, value);
        ...
        {
             Engage.Digital.Client.ApiResponse<ReplyAssistantEntry> localVarResponse = await UpdateReplyAssistantEntryAsyncWithHttpInfo(replyAssistantEntryId, label, foreignId, categoryIds, shortcuts, entryGroupId, sourceIds);
             return localVarResponse.Data;
        ...
        /// <param name="sourceIds">Source ids (array) (optional)</param>
        /// <returns>Task of ApiResponse (ReplyAssistantEntry)</returns>
        public async System.Threading.Tasks.Task<Engage.Digital.Client.ApiResponse<ReplyAssistantEntry>> UpdateReplyAssistantEntryAsyncWithHttpInfo (string replyAssistantEntryId, string label = null, string foreignId = null, List<string> categoryIds = null, List<string> shortcuts = null, string entryGroupId = null, List<string> sourceIds = null)
        {
            // verify the required parameter 'replyAssistantEntryId' is set
            if (replyAssistantEntryId == null)
                throw new Engage.Digital.Client.ApiException(400, "Missing required parameter 'replyAssistantEntryId' when calling ReplyAssistantEntriesApi->UpdateReplyAssistantEntry");
